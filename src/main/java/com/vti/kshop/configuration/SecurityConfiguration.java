...
import com.vti.kshop.exception.ErrorHandler;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(customizer -> customizer
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/cars/**", "/api/v1/accessories/**")
                        .hasAnyAuthority(User.Role.ADMIN.name(), User.Role.MANAGER.name())
                        .requestMatchers(HttpMethod.PUT, "/api/v1/cars/**", "/api/v1/accessories/**")
                        .hasAnyAuthority(User.Role.ADMIN.name(), User.Role.MANAGER.name())
